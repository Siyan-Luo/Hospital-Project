...
layui.define(function(exports){
  ...
  Class.prototype.view = function(){
    ...
    ,views = {
      ...
      //数据总数
      ,count: '<span class="layui-laypage-count"> '+ config.count +' Records</span>'
      ...
      //   ,'</span>'].join('');
      // }()
      return ['<span class="layui-laypage-skip">Page'
      , '<input type="text" min="1" value="' + config.curr + '" class="layui-input">'
      , '<button type="button" class="layui-laypage-btn">Skip</button>'
      , "</span>"].join("") }()
